...
public class ParentDao_Impl(
  __db: RoomDatabase,
) : ParentDao {
  private val __db: RoomDatabase

  private val __insertAdapterOfAcudienteEntity: EntityInsertAdapter<AcudienteEntity>

  private val __insertAdapterOfEstudianteAcudienteEntity:
      EntityInsertAdapter<EstudianteAcudienteEntity>

  private val __insertAdapterOfPreferenciaNotificacionEntity:
      EntityInsertAdapter<PreferenciaNotificacionEntity>

  private val __updateAdapterOfAcudienteEntity: EntityDeleteOrUpdateAdapter<AcudienteEntity>
  init {
    this.__db = __db
    this.__insertAdapterOfAcudienteEntity = object : EntityInsertAdapter<AcudienteEntity>() {
      protected override fun createQuery(): String =
          "INSERT OR REPLACE INTO `acudientes` (`idAcudiente`,`nombreCompleto`,`tipoDocumento`,`numeroDocumento`,`correoElectronico`,`telefono`,`whatsapp`,`direccion`,`parentesco`,`estado`,`fechaRegistro`,`fechaActualizacion`,`passwordHash`,`preferenciasJson`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

      protected override fun bind(statement: SQLiteStatement, entity: AcudienteEntity) {
        statement.bindText(1, entity.idAcudiente)
        statement.bindText(2, entity.nombreCompleto)
        statement.bindText(3, entity.tipoDocumento)
        statement.bindText(4, entity.numeroDocumento)
        statement.bindText(5, entity.correoElectronico)
        statement.bindText(6, entity.telefono)
        val _tmpWhatsapp: String? = entity.whatsapp
        if (_tmpWhatsapp == null) {
          statement.bindNull(7)
        } else {
          statement.bindText(7, _tmpWhatsapp)
        }
        val _tmpDireccion: String? = entity.direccion
        if (_tmpDireccion == null) {
          statement.bindNull(8)
        } else {
          statement.bindText(8, _tmpDireccion)
        }
        statement.bindText(9, entity.parentesco)
        val _tmp: Int = if (entity.estado) 1 else 0
        statement.bindLong(10, _tmp.toLong())
        statement.bindLong(11, entity.fechaRegistro)
        statement.bindLong(12, entity.fechaActualizacion)
        val _tmpPasswordHash: String? = entity.passwordHash
        if (_tmpPasswordHash == null) {
          statement.bindNull(13)
        } else {
          statement.bindText(13, _tmpPasswordHash)
        }
        val _tmpPreferenciasJson: String? = entity.preferenciasJson
        if (_tmpPreferenciasJson == null) {
          statement.bindNull(14)
        } else {
          statement.bindText(14, _tmpPreferenciasJson)
        }
      }
    }
    this.__insertAdapterOfEstudianteAcudienteEntity = object :
        EntityInsertAdapter<EstudianteAcudienteEntity>() {
      protected override fun createQuery(): String =
          "INSERT OR REPLACE INTO `estudiantes_acudientes` (`idRelacion`,`idEstudiante`,`idAcudiente`,`esPrincipal`,`puedeRetirar`,`recibeNotificaciones`) VALUES (?,?,?,?,?,?)"

      protected override fun bind(statement: SQLiteStatement, entity: EstudianteAcudienteEntity) {
        statement.bindText(1, entity.idRelacion)
        statement.bindText(2, entity.idEstudiante)
        statement.bindText(3, entity.idAcudiente)
        val _tmp: Int = if (entity.esPrincipal) 1 else 0
        statement.bindLong(4, _tmp.toLong())
        val _tmp_1: Int = if (entity.puedeRetirar) 1 else 0
        statement.bindLong(5, _tmp_1.toLong())
        val _tmp_2: Int = if (entity.recibeNotificaciones) 1 else 0
        statement.bindLong(6, _tmp_2.toLong())
      }
    }
    this.__insertAdapterOfPreferenciaNotificacionEntity = object :
        EntityInsertAdapter<PreferenciaNotificacionEntity>() {
      protected override fun createQuery(): String =
          "INSERT OR REPLACE INTO `preferencias_notificaciones` (`id`,`institutionId`,`usuarioId`,`tipoEvento`,`push`,`inApp`,`email`,`sms`,`syncStatus`,`lastModified`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)"

      protected override fun bind(statement: SQLiteStatement,
          entity: PreferenciaNotificacionEntity) {
        statement.bindLong(1, entity.id)
        statement.bindText(2, entity.institutionId)
        statement.bindText(3, entity.usuarioId)
        statement.bindText(4, entity.tipoEvento)
        val _tmp: Int = if (entity.push) 1 else 0
        statement.bindLong(5, _tmp.toLong())
        val _tmp_1: Int = if (entity.inApp) 1 else 0
        statement.bindLong(6, _tmp_1.toLong())
        val _tmp_2: Int = if (entity.email) 1 else 0
        statement.bindLong(7, _tmp_2.toLong())
        val _tmp_3: Int = if (entity.sms) 1 else 0
        statement.bindLong(8, _tmp_3.toLong())
        statement.bindLong(9, entity.syncStatus.toLong())
        statement.bindLong(10, entity.lastModified)
      }
    }
    this.__updateAdapterOfAcudienteEntity = object : EntityDeleteOrUpdateAdapter<AcudienteEntity>()
        {
      protected override fun createQuery(): String =
          "UPDATE OR ABORT `acudientes` SET `idAcudiente` = ?,`nombreCompleto` = ?,`tipoDocumento` = ?,`numeroDocumento` = ?,`correoElectronico` = ?,`telefono` = ?,`whatsapp` = ?,`direccion` = ?,`parentesco` = ?,`estado` = ?,`fechaRegistro` = ?,`fechaActualizacion` = ?,`passwordHash` = ?,`preferenciasJson` = ? WHERE `idAcudiente` = ?"
      ...
      protected override fun bind(statement: SQLiteStatement, entity: AcudienteEntity) {
        ...
        statement.bindText(15, entity.idAcudiente)
      }
    }
  }

  public override suspend fun insertAcudiente(acudiente: AcudienteEntity): Unit =
      performSuspending(__db, false, true) { _connection ->
    __insertAdapterOfAcudienteEntity.insert(_connection, acudiente)
  }

  public override suspend fun insertVinculacion(vinculacion: EstudianteAcudienteEntity): Unit =
      performSuspending(__db, false, true) { _connection ->
    __insertAdapterOfEstudianteAcudienteEntity.insert(_connection, vinculacion)
  }

  public override suspend fun insertPreferencias(preferencias: PreferenciaNotificacionEntity): Unit
      = performSuspending(__db, false, true) { _connection ->
    __insertAdapterOfPreferenciaNotificacionEntity.insert(_connection, preferencias)
  }

  public override suspend fun updateAcudiente(acudiente: AcudienteEntity): Unit =
      performSuspending(__db, false, true) { _connection ->
    __updateAdapterOfAcudienteEntity.handle(_connection, acudiente)
  }

  public override suspend fun getAcudienteById(id: String): AcudienteEntity? {
    val _sql: String = "SELECT * FROM acudientes WHERE idAcudiente = ?"
    return performSuspending(__db, true, false) { _connection ->
      ...
      try {
        ...
        val _columnIndexOfNombreCompleto: Int = getColumnIndexOrThrow(_stmt, "nombreCompleto")
        val _columnIndexOfTipoDocumento: Int = getColumnIndexOrThrow(_stmt, "tipoDocumento")
        val _columnIndexOfNumeroDocumento: Int = getColumnIndexOrThrow(_stmt, "numeroDocumento")
        val _columnIndexOfCorreoElectronico: Int = getColumnIndexOrThrow(_stmt, "correoElectronico")
        val _columnIndexOfTelefono: Int = getColumnIndexOrThrow(_stmt, "telefono")
        val _columnIndexOfWhatsapp: Int = getColumnIndexOrThrow(_stmt, "whatsapp")
        val _columnIndexOfDireccion: Int = getColumnIndexOrThrow(_stmt, "direccion")
        val _columnIndexOfParentesco: Int = getColumnIndexOrThrow(_stmt, "parentesco")
        val _columnIndexOfEstado: Int = getColumnIndexOrThrow(_stmt, "estado")
        val _columnIndexOfFechaRegistro: Int = getColumnIndexOrThrow(_stmt, "fechaRegistro")
        ...
        val _columnIndexOfPreferenciasJson: Int = getColumnIndexOrThrow(_stmt, "preferenciasJson")
        val _result: AcudienteEntity?
        if (_stmt.step()) {
          ...
          val _tmpTipoDocumento: String
          _tmpTipoDocumento = _stmt.getText(_columnIndexOfTipoDocumento)
          val _tmpNumeroDocumento: String
          _tmpNumeroDocumento = _stmt.getText(_columnIndexOfNumeroDocumento)
          val _tmpCorreoElectronico: String
          _tmpCorreoElectronico = _stmt.getText(_columnIndexOfCorreoElectronico)
          val _tmpTelefono: String
          _tmpTelefono = _stmt.getText(_columnIndexOfTelefono)
          val _tmpWhatsapp: String?
          if (_stmt.isNull(_columnIndexOfWhatsapp)) {
            _tmpWhatsapp = null
          } else {
            _tmpWhatsapp = _stmt.getText(_columnIndexOfWhatsapp)
          }
          ...
          val _tmpParentesco: String
          _tmpParentesco = _stmt.getText(_columnIndexOfParentesco)
          val _tmpEstado: Boolean
          val _tmp: Int
          _tmp = _stmt.getLong(_columnIndexOfEstado).toInt()
          _tmpEstado = _tmp != 0
          val _tmpFechaRegistro: Long
          _tmpFechaRegistro = _stmt.getLong(_columnIndexOfFechaRegistro)
          ...
          val _tmpPreferenciasJson: String?
          if (_stmt.isNull(_columnIndexOfPreferenciasJson)) {
            _tmpPreferenciasJson = null
          } else {
            _tmpPreferenciasJson = _stmt.getText(_columnIndexOfPreferenciasJson)
          }
          _result =
              AcudienteEntity(_tmpIdAcudiente,_tmpNombreCompleto,_tmpTipoDocumento,_tmpNumeroDocumento,_tmpCorreoElectronico,_tmpTelefono,_tmpWhatsapp,_tmpDireccion,_tmpParentesco,_tmpEstado,_tmpFechaRegistro,_tmpFechaActualizacion,_tmpPasswordHash,_tmpPreferenciasJson)
        } else {
          _result = null
        }
        _result
  ...
  public override suspend fun getAcudienteByEmail(email: String): AcudienteEntity? {
    val _sql: String = "SELECT * FROM acudientes WHERE correoElectronico = ?"
    return performSuspending(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
  ...
  public override suspend fun getAcudienteByDocument(document: String): AcudienteEntity? {
    val _sql: String = "SELECT * FROM acudientes WHERE numeroDocumento = ?"
    return performSuspending(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
        _stmt.bindText(_argIndex, document)
        val _columnIndexOfIdAcudiente: Int = getColumnIndexOrThrow(_stmt, "idAcudiente")
        val _columnIndexOfNombreCompleto: Int = getColumnIndexOrThrow(_stmt, "nombreCompleto")
        val _columnIndexOfTipoDocumento: Int = getColumnIndexOrThrow(_stmt, "tipoDocumento")
        val _columnIndexOfNumeroDocumento: Int = getColumnIndexOrThrow(_stmt, "numeroDocumento")
  ...
  public override suspend fun getEstudiantesByAcudiente(idAcudiente: String): List<StudentEntity> {
    val _sql: String = """
        |
        |        SELECT s.* FROM students s
        |        INNER JOIN estudiantes_acudientes ea ON s.id = ea.idEstudiante
        |        WHERE ea.idAcudiente = ?
        |    
        """.trimMargin()
    return performSuspending(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
  ...
  public override suspend fun getAcudientesByEstudiante(idEstudiante: String):
      List<AcudienteEntity> {
    val _sql: String = """
        |
    ...
    return performSuspending(__db, true, false) { _connection ->
      ...
      try {
        var _argIndex: Int = 1
        _stmt.bindText(_argIndex, idEstudiante)
        val _columnIndexOfIdAcudiente: Int = getColumnIndexOrThrow(_stmt, "idAcudiente")
        val _columnIndexOfNombreCompleto: Int = getColumnIndexOrThrow(_stmt, "nombreCompleto")
        val _columnIndexOfTipoDocumento: Int = getColumnIndexOrThrow(_stmt, "tipoDocumento")
        val _columnIndexOfNumeroDocumento: Int = getColumnIndexOrThrow(_stmt, "numeroDocumento")
        ...
        val _columnIndexOfPasswordHash: Int = getColumnIndexOrThrow(_stmt, "passwordHash")
        val _columnIndexOfPreferenciasJson: Int = getColumnIndexOrThrow(_stmt, "preferenciasJson")
        val _result: MutableList<AcudienteEntity> = mutableListOf()
        while (_stmt.step()) {
          val _item: AcudienteEntity
          val _tmpIdAcudiente: String
          _tmpIdAcudiente = _stmt.getText(_columnIndexOfIdAcudiente)
          val _tmpNombreCompleto: String
          _tmpNombreCompleto = _stmt.getText(_columnIndexOfNombreCompleto)
  ...
  public override suspend fun getPreferenciasByAcudiente(idAcudiente: String):
      PreferenciaNotificacionEntity? {
    val _sql: String = "SELECT * FROM acudiente_preferencias WHERE idAcudiente = ?"
    return performSuspending(__db, true, false) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        var _argIndex: Int = 1
  ...
  public override suspend fun deleteVinculacion(idEstudiante: String, idAcudiente: String) {
    val _sql: String =
        "DELETE FROM estudiantes_acudientes WHERE idEstudiante = ? AND idAcudiente = ?"
  ...
  public override suspend fun deleteAllAcudientes() {
    val _sql: String = "DELETE FROM acudientes"
    return performSuspending(__db, false, true) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        _stmt.step()
  ...
  public override suspend fun deleteAllVinculaciones() {
    val _sql: String = "DELETE FROM estudiantes_acudientes"
    return performSuspending(__db, false, true) { _connection ->
      val _stmt: SQLiteStatement = _connection.prepare(_sql)
      try {
        _stmt.step()
